...
const helperFunc = (input_time, weekdays, input_day_index, next_open_day_schedule) => {
    ...
    if (total_hours >= 24) {
      ...
      return `Shop is Currently Closed. and it will be open after ${days} Days and ${hours} Hrs`;
    }
    else {
      return `Shop is Currently Closed. and it will be open after ${total_hours} Hrs`;
    }
}
...
const findNextOpenTimeInHoursAndDays = (input_time, input_weekday, weekdays) => {
...
module.exports = findNextOpenTimeInHoursAndDays;
